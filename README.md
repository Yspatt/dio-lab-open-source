...
4. Crie/Referencie uma nova **branch** e nomeie como `feat/community/seunomedeusuario`:'git checkout -b feat/community/yanspatt'
    > Exemplo: 'git checkout -b feat/community/yanspatt'
